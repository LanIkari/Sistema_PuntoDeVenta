...
public class UsuarioControl {
    ...
    public UsuarioControl() {
        ...
        this.DATOSROL = new RolDAO();//Con este objeto podemos hacer referencia a los objetos de nuestraclase CategoriaDAO
    ...
    public DefaultTableModel listar(String texto, int totalPorPagina, int numPagina) {
        ...
        String[] titulos = {"Id", "Rol ID", "Rol", " Usuario", "Documento", "# Documento", "Direccion", "Telefono", "Emal", "clave", "Estado"};
    ...
    public String insertar(int RolId, String nombre, String tipoDocumento, String numDocumento, String direccion, String telefono, String email, String clave) {
        if (DATOS.existe(email)) {
            ...
            obj.setEmail(email);
            obj.setClave(this.encriptar(clave));//Vamos a encriptar esta clave
