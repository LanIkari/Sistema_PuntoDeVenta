...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/images/acceso (1) (1).png"))); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (txtClave.getText().length()==0 || txtClave.getText().length()>64){
            JOptionPane.showMessageDialog(this, "Debes ingresar una clave de acceso y esta no debe de superar los 64 caracteres.", "Sistema",JOptionPane.WARNING_MESSAGE);
        ...
        if(resp.equals("1")){
            ...
            JOptionPane.showMessageDialog(this, "Usuario no tine acceso.","Sistema",JOptionPane.ERROR_MESSAGE);
        }else{
